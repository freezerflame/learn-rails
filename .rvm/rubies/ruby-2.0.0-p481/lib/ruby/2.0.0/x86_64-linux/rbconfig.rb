...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/rvm/rubies/ruby-2.0.0-p481")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/rvm/rubies/ruby-2.0.0-p481' '--enable-load-relative' '--sysconfdir=/etc' '--disable-install-doc' '--enable-shared'"
